...
function recursivebinarySearch(arr, val){//     DNF
    for (i=0;i<arr.length;i++){
        if (val>arr[i]){
            if (i<arr.length){
                var newarr=[]
                for (j=0;j<arr.lenght/2;j++){
                    newarr+=arr[j]
                }
                return recursivebinarySearch(newarr, val)
            }
            else if (i>arr.length){
                var newarr=[]
                for (j=arr.length/2;j<arr.lenght;j++){
                    newarr+=arr[j]
                }
                return recursivebinarySearch(newarr, val)
            }
...
console.log(recursivebinarySearch([1,2], 1));
console.log(recursivebinarySearch([1,2,2], 2));
console.log(recursivebinarySearch([], 7));
console.log(recursivebinarySearch([1,2,2,2,2,2,4,5,5,5,5,6,6,6], 2));
console.log(recursivebinarySearch([1,1,1,1,1], 1));
console.log(recursivebinarySearch([1,2,3,3,4,4,5,6,7,8,8,9,10], 8));
